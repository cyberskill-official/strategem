...
related_frs: [FR-PLAT-011, FR-WEB-001, FR-WEB-002, FR-API-002]
depends_on: [FR-PLAT-011]
blocks: []
new_paths:
...
This FR ships the **user web** surface to **Vercel**. The Next.js app under `apps/web` SHALL build on Vercel. Runtime configuration SHALL include:
...
The browser SHALL NOT embed Supabase service-role keys. CORS on the API (FR-PLAT-013) SHALL allow the Vercel production and preview origins.
