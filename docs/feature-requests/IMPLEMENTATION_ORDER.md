...
|---|---|---|--:|---|---|---|
| PLAT-001 | Monorepo + hybrid workspace + CI skeleton | MUST | 12 | - | yes | ready_to_implement |
...
| CORE-007 | Ganzhi primitives + relations | MUST | 8 | PLAT-001 | yes | blocked |
| RULE-001 | Pattern-as-data schema + knowledge_patterns | MUST | 8 | PLAT-003 | yes | blocked |
