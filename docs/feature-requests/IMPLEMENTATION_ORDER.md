...
| CORE-003 | Four pillars (Ngu Ho/Ngu Thu don, zi-hour) | MUST | 16 | CORE-001, CORE-002 | yes | in_review |
...
| RULE-002 | Condition DSL + evaluator + scoring | MUST | 12 | RULE-001 | yes | in_review |
...
| RAG-002 | Hybrid retriever (vector arm P0; graph via KB-005) | MUST | 12 | RAG-001 | yes | in_review |
...
| WEB-001 | App shell + Design System v1.3.0 + components | MUST | 18 | PLAT-001 | yes | in_review |
