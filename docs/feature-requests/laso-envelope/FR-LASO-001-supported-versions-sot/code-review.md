...
| Check | Result |
|---|---|
| Correctness vs FR | PASS — matches all 4 normative clauses |
...
- `APPROVE review FR-LASO-001` — advances to `ready_to_test`
- `REJECT review FR-LASO-001: <reason>` — routes back to `ready_to_implement`
