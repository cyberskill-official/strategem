...
These tasks close **residual product + oracle acceptance** gaps. Many original module tasks are already `done` at package level; COV-* is the integration/certification layer required for **100% coverage claims**.
