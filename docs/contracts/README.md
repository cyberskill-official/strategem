...
Current:
- (FR-PLAT-002) laso-envelope.schema.json — the la so JSON envelope (strategy 4.3). Every engine emits it exactly; the Python interpretation branch consumes it read-only.
