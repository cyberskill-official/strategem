-- TASK-PLAT-003: knowledge_patterns — table owned jointly with TASK-RULE-001 (conditions DSL).
-- Seeded classical knowledge (TASK-KB-002): world-readable, admin/curator write (see 0009).
